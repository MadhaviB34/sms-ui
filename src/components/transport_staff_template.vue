<template>
    <div>
        <div class="col-lg-12 text-left">
            <h3 class="student-head">Drivers</h3>
            <hr>
        </div>
        <div class="col-lg-12 ">
        ...
        <div class="col-lg-12">
            <div class="divTable">
                <div class="divTableBody">
                    ...
                    <div class="divTableRowdata" v-for="driver in staffs">
                        ...
                        <div class="divTableCelldata"><a data-toggle="modal" href="#editdriver" v-on:click.prevent="editstaff(driver)"><i class="fa fa-pencil-square-o fa-1x" aria-hidden="true"></i></a></div>
                        <div class="divTableCelldata"><a data-toggle="modal" v-on:click.prevent="deletestaff(driver)"><i class="fa fa-trash fa-1x" aria-hidden="true"></i></a></div>    
                    </div>
                </div>
            </div>
        </div> 
