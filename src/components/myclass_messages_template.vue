<template>
   <div>
        ...
        <div class="col-lg-12 text-left" >
           <h3 class="student-head">Messages</h3>
           <hr>
        </div>
        </div>
        <div class="row">
        ...
        <div class="row reset-padding reset-margin">
            <div class="col-lg-12 messageborder" v-for="message in messages">
                ...
                <div class="col-lg-12" v-for="reply in message.replymessages">
                    ...
                    <div class="col-lg-11">
                    <div class="row">
                        <div class="col-lg-3"  v-if="reply.sentflag=='T'">
    ...
    export default{
        ...
        methods:{
            ...
            Newmessage:function(){
                ...
                for(var i=0;i<this.newmessage.students.length;i++){
                    var studentid=this.newmessage.students[i].id
                }
