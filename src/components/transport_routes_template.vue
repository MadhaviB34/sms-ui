<template>
    <div>
        <div class="col-lg-12 text-left">
            <h3 class="student-head">Routes</h3>
            <hr>
        </div>
        <div class="col-lg-12">
        ...
        <div class="col-lg-12">
            <div class="divTable">
                <div class="divTableBody">
                    ...
                    <div class="divTableRowdata" v-for="route in routes">
                        ...
                        <div class="divTableCelldata">{{route.stops}}</div>
                        <div class="divTableCelldata"><a data-toggle="modal" href="#myModal"><i class="fa fa-plus" aria-hidden="true"></i></a></div>
                        ...
                        <form name="newstopform">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-lg-offset-3 text-center">
                                    ...
                                    <button id="btn-Register" type="submit" name="submit" v-on:click.prevent="updateroute" class="btn button" >Update</button>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="multi">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-lg-offset-3 text-center">
                                         <button id="btn-Register" type="submit" name="submit" v-on:click.prevent="assignStops" class="btn submitbutton" >Submit</button>
                                    </div>
                                </div>
                        </form>
                    </div>
    ...
    methods:{
        ...
        assignStops(){
            for(var i=0;i<$('#select-to option').attr('selected','selected').length;i++){
                ...
                this.assignstops.push(stopname);
            }
           console.log(this.assignstops)
        }
    },
}
</script>
