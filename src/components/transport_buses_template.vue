<template>
    <div>
        <div class="col-lg-12 text-left">
            <h3 class="student-head">Buses</h3>
            <hr>
        </div>
        <div class="col-lg-12">
        ...
        <div class="col-lg-12">
            <div class="divTable">
                <div class="divTableBody">
                    ...
                    <div class="divTableRowdata" v-for="bus in buses">
                        ...
                        <div class="divTableCelldata"><a data-toggle="modal" href="#editbuses" v-on:click.prevent="editBus(bus)"><i class="fa fa-pencil-square-o fa-1x" aria-hidden="true"></i></a></div>
                        <div class="divTableCelldata"><a data-toggle="modal" v-on:click.prevent="deletebus(bus)" ><i class="fa fa-trash fa-1x" aria-hidden="true"></i></a></div>    
